...
import 'package:skill_share_user/Screens/videos.dart';
import 'package:skill_share_user/config/styles.dart';
import 'package:skill_share_user/firebase/functions.dart';

class Videomentor extends StatelessWidget {
  const Videomentor({super.key});

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(title: const Text("Video Mentors")),
      body: StreamBuilder(
        stream: firestore
            .collection("learning")
